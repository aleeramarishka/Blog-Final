...
app = Flask(__name__)
app.config['SECRET_KEY'] = '8BYkEfBA6O6dkji3klswdf656PUtarevdf'
...
# wrapper function for protecting routes
def admin_only(f):
    @wraps(f)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        check_for_email = db.session.query(User).filter_by(email=email).first()
